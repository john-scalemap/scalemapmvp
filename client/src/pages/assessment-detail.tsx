...
type AssessmentDetailData = Assessment & {
...
export default function AssessmentDetail({ params }: AssessmentDetailProps) {
  ...
  useEffect(() => {
    if (!authLoading && !isAuthenticated) {
      toast({
        ...
        description: "Please log in to view this assessment.",
        variant: "destructive",
      });
      setLocation('/auth');
    }
  ...
  const { data: assessmentData, isLoading } = useQuery<AssessmentDetailData>({
